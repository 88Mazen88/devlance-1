...
class _BankAccountPageState extends State<BankAccountPage> {
  ...
  void didChangeDependencies() {
    ...
    _profileArgs = ModalRoute.of(context)?.settings.arguments as ProfileArgs?;
    if (_profileArgs != null) {
      _cardholderController.text = _profileArgs!.fullName ?? '';
    }
  }
                    ...
                    ? () {
                        if (_formKey.currentState!.validate()) {
                          Navigator.pushNamed(
                            context,
                            '/verified-account',
                            arguments: _profileArgs?.fullName ?? _cardholderController.text,
                          );
                        }
                      }
                    : null,
